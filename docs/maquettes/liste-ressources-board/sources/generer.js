/* Maquette « Liste des ressources » en tableau (Directions & équipes), injectée dans la vraie
   application servie par le serveur simulé. Usage : node docs/maquettes/liste-ressources-board/sources/generer.js */
...
(async () => {
  ...
  await p.screenshot({ path: path.resolve(__dirname, '../liste-ressources-board.png') });
