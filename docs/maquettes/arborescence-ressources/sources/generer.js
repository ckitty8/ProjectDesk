/* Maquette « Arborescence Direction → Équipe → Projet → Membres », injectée dans la vraie
   application servie par le serveur simulé. Usage : node docs/maquettes/arborescence-ressources/sources/generer.js */
...
(async () => {
  ...
  await p.screenshot({ path: path.resolve(__dirname, '../arborescence-ressources.png') });
